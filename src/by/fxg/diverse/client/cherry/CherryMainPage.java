...
import by.fxg.diverse.client.render.VRenderHelper;
...
public class CherryMainPage extends GuiScreen {
	...
	protected void actionPerformed(GuiButton b) {
		if (b.id == 0) {
			...
			this.mc.displayGuiScreen(new CherryItemPage(this, Viod.clientManager.clientWikiDatabase.itemWiki));
		} else if (b.id == 3) {
			this.mc.displayGuiScreen(new CherryBlockPage(this, Viod.clientManager.clientWikiDatabase.blockWiki));
		}
	}
	...
	public void drawScreen(int par1, int par2, float par3) {
		...
		VRenderHelper.renderItemStackIntoGUI(new ItemStack(ItemRegistry.rpgFood, 1, 2), 10, 10);
