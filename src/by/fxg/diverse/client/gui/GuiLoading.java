...
public class GuiLoading extends GuiScreen {
	...
	private ResourceLocation black = new ResourceLocation("diverse:start/black.png");
		...
		if (this.timer1 >= 10) {
			...
			this.timer2 += 0.02F;
				...
				if (this.timer3 >= 110) {
					...
					this.timer2 = 0.0F;
					this.timer3 = 0;
					Viod.clientManager.gameStarted = true;
					if (Switch.isClient) this.mc.displayGuiScreen(new GuiConnecting(new GuiMainMenu(), this.mc, "193.70.81.74", 25132));
