package by.fxg.diverse.client.render;

import org.lwjgl.opengl.GL11;

import by.fxg.diverse.client.model.VModel;
import by.fxg.diverse.common.tile.VTileBase;
...
public class VRenderBase extends TileEntitySpecialRenderer implements IItemRenderer {
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
		...
		case EQUIPPED:
			...
			Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("diverse:textures/models/" + this.texture + ".png"));
	...
	public void renderTileEntity(VTileBase tile, double dl, double d2, double d3, float f) {
		...
		GL11.glScalef(this.scale, this.scale, this.scale);
		Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("diverse:textures/models/" + texture + ".png"));
		((VModel)this.model).render();
		GL11.glPopMatrix();
	}
}
