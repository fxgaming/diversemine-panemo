...
public class ContainerBlockPress extends ContainerBase {
   private TilePress tileentity;
   private boolean work = false;
   private int time = 0;
   private int item1 = 0;
   private int item2 = 0;

   public ContainerBlockPress(InventoryPlayer inventoryplayer, TilePress tileentity) {
