...
public class CherryItemPage extends CherryMainPage {
	...
	public CherryItemPage(CherryMainPage scr, ArrayList<ItemWiki> arr) {
		this.screen = scr;
	...
	public void drawScreen(int par1, int par2, float par3) {
		...
		VRenderHelper.renderText("Предметы можно прокрутить колёсиком мыши!", 15, 41);
		if (this.iid != -1) {
			VRenderHelper.renderText("Выбранный предмет:", 225, 57);
